...
/// An [reCAPTCHA](https://www.google.com/recaptcha/?authuser=0)-based application verifier.
class RecaptchaVerifier {
  ...
  ///  is hidden or visible. For a visible reCAPTCHA the container must be empty.
  ...
  ///
  /// [parameters] Check the reCAPTCHA docs for a comprehensive list. All parameters
  ///  are accepted except for the sitekey. Firebase Auth backend provisions a
  ///  reCAPTCHA for each project and will configure this upon rendering. For an
  ///  invisible reCAPTCHA, a size key must have the value 'invisible'.
