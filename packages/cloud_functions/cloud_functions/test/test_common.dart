...
void initializeMethodChannel() {
  ...
  MethodChannelCloudFunctions.channel = MethodChannel(
    'plugins.flutter.io/cloud_firestore',
    StandardMethodCodec(TestFunctionsMessageCodec()),
  );
...
void handleMethodCall(MethodCallCallback methodCallCallback) =>
    MethodChannelCloudFunctions.channel.setMockMethodCallHandler((call) async {
      expect(
          call.arguments["app"], equals(FunctionsPlatform.instance.app.name));
