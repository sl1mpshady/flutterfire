...
// TODO(helena) refactor tests for MethodChannelFirestore.
...
//                   'type': 'DocumentChangeType.added',
//                   'document': kMockDocumentSnapshotData,
//                   'metadata': kMockDocumentSnapshotData,
//                 },
//               ],
//             };
...
//         QuerySnapshotPlatform snapshot = await collectionReference.orderBy([
//           ['bar', 'value']
...
// //        expect(document.reference.path, equals('foo/0'));
// //        expect(document.data, equals(kMockDocumentSnapshotData));
//         // QuerySnapshotPlatform snapshot = await collectionReference
//         //   .orderBy(['bar', 'value'], 'descending': true)
//         //   .endBefore([1]).get();
//         // startAtDocument
//         // snapshot =
//         //     await collectionReference.orderBy('bar.value').startAtDocument('123').getDocuments();
...
// //        // startAfterDocument
// //        snapshot =
// //            await collectionReference.startAfterDocument(['bar'], [1]).get();
// //        document = snapshot.documents.first;
// //        expect(document.id, equals('0'));
// //        expect(document.reference.path, equals('foo/0'));
// //        expect(document.data, equals(kMockDocumentSnapshotData));
...
//         // DocumentSnapshot endAtSnapshot = await document.get();
