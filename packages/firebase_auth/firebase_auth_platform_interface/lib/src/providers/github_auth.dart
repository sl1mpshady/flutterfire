...
/// ```
///
/// If authenticating with GitHub via a 3rd party, use the returned `accessToken`
...
/// The authentical credential returned from calling [GithubAuthProvider.credential].
