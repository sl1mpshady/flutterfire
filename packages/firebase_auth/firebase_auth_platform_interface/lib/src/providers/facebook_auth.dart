...
/// ```
///
/// If authenticating with Facebook via a 3rd party, use the returned `accessToken`
...
/// The authentical credential returned from calling [FacebookAuthProvider.credential].
