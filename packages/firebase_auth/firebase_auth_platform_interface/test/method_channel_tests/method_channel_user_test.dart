...
void main() {
  ...
  String kMockDisplayName = 'Flutter Test User';
  String kMockPhotoURL = 'http://www.example.com/';
  const String kMockEmail = 'test@example.com';
  const String kMockIdToken = '12345';
  String kMockPhoneNumber = '5555555555';
  ...
  group('$MethodChannelUser', () {
      ...
      handleMethodCall((call) async {
        ...
        switch (call.method) {
          ...
          case 'User#updatePhoneNumber':
            user = generateUser(
                user, <String, dynamic>{'phoneNumber': kMockPhoneNumber});
            break;
    ...
    group('updatePhoneNumber()', () {
      String newPhoneNumber = '5555555556';
      kMockPhoneNumber = newPhoneNumber;
      ...
      test('gets result successfully', () async {
        ...
        await auth.currentUser.reload();
        expect(auth.currentUser.phoneNumber, newPhoneNumber);
      });
